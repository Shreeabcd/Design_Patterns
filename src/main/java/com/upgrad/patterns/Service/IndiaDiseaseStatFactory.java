...
public class IndiaDiseaseStatFactory {
    ...
    public IndianDiseaseStat GetInstance (SourceType sourceType) {
        ...
        if(sourceType.equals(SourceType.JohnHopkins))
        {
            return this.johnHopkinsStrategy;
        }
        else if (sourceType.equals(SourceType.DiseaseSh))
        {
...
//            return this.johnHopkinsStrategy;
        ...
        {
            String message = String.format("invalid disease strategy/sourceType");
